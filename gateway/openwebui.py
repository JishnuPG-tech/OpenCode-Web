"""
Open WebUI Gateway Router (Native Root Proxy)
=============================================
Proxies root '/' and Open WebUI API/WebSocket/static endpoints directly to Open WebUI on port 8098.
"""
...
async def webui_sw(request: Request):
    ...
    res = await proxy_http_request(target, request)
